...
def classify_with_regex(log_message):
    regex_patterns = {
        ...
        r"Backup completd successfully." : "System Notification",
        r"System updated to version .*" : "System Notification",
        r"File .* uploaded succeessfully by user .*" : "System Notofication",
...
if __name__ == "__main__":
    ...
    print(classify_with_regex("Disck cleanup completed successfully."))
    print(classify_with_regex("System reboot initiated by user user1."))
    print(classify_with_regex("Hey bro, chill!"))
